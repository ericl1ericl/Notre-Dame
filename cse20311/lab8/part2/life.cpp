...
int main(int argc, char *argv[]) {
   Lifeboard board; // creates Lifeboard class for current board
   Lifeboard nextboard; // creates Lifeboard class for next board
...
void fadvance(Lifeboard &board, Lifeboard &nextboard) { // advances board
